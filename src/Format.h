...
namespace OSK::GRAPHICS {
	...
	unsigned int OSKAPI_CALL GetFormatNumberOfBytes(Format format);
	...
	Format OSKAPI_CALL GetColorFormat(unsigned int numChannels);
	...
	Format OSKAPI_CALL GetFormatFromString(const std::string& formatStr);

	bool OSKAPI_CALL FormatSupportsStencil(Format format);
