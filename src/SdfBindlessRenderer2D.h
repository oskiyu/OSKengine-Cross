...
namespace OSK::GRAPHICS {
	...
	private:
		...
		DynamicArray<UniquePtr<GpuBuffer>> m_globalInformationBuffers{};

		/// @brief Contendrá el slot de información global.
		DynamicArray<UniquePtr<MaterialInstance>> m_globalInformationInstances{};
		...
		/// instancias.
		DynamicArray<DynamicArray<UniquePtr<GpuBuffer>>> m_drawCallsBuffers;

		/// @brief Lista con las instancias configuradas de tal
		/// manera que a cada una le corresponda un buffer
		/// de `m_drawCallsBuffers`.
		DynamicArray<DynamicArray<UniquePtr<MaterialInstance>>> m_drawCallsBuffersInstances;
