...
namespace OSK::GRAPHICS {
	...
	public:
		...
		virtual UniquePtr<class ICommandPool> CreateGraphicsCommandPool() = 0;
		...
		/// @throws CommandPoolCreationException Si ocurre algún error. 
		virtual UniquePtr<ICommandPool> CreateComputeCommandPool() = 0;
		...
		virtual UniquePtr<IGpuImageSampler> CreateSampler(const GpuImageSamplerDesc& info) const = 0;
		...
		virtual std::optional<UniquePtr<ICommandPool>> CreateTransferOnlyCommandPool() = 0;
