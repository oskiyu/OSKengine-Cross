...
namespace OSK::ASSETS {
	...
	class OSKAPI_CALL FontLibraryInitializationException : public EngineException {
	...
	class OSKAPI_CALL FontLodaingException : public EngineException {
	...
	class OSKAPI_CALL FontCharacterLodaingException : public EngineException {
