...
namespace OSK::GRAPHICS {
	...
	class OSKAPI_CALL ModelAnimationNotFoundException : public EngineException {
	...
	class OSKAPI_CALL ModelSkinNotFoundException : public EngineException {
	...
	class OSKAPI_CALL BoneNotFoundException : public EngineException {
	...
	class OSKAPI_CALL BoneAlreadyAddedException : public EngineException {
