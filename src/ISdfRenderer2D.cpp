...
void OSK::GRAPHICS::ISdfRenderer2D::SetCamera(Vector2f position, Vector2f size) {
	m_currentCameraMatrix = glm::ortho<float>(position.x, size.x, position.y + size.y, 0.0f, -1.0f, 1.0f);
}
