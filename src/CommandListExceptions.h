...
namespace OSK::GRAPHICS {
	...
	class OSKAPI_CALL CommandListResetException : public EngineException {
	...
	class OSKAPI_CALL CommandListStartException : public EngineException {
	...
	class OSKAPI_CALL CommandListEndException : public EngineException {
	...
	class OSKAPI_CALL CommandListCreationException : public EngineException {
	...
	/// su vertex view.
	class OSKAPI_CALL InvalidVertexBufferException : public EngineException {
	...
	/// su index view.
	class OSKAPI_CALL InvalidIndexBufferException : public EngineException {
