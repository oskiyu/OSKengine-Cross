...
namespace OSK::GRAPHICS {
	...
	class OSKAPI_CALL PipelineCreationException : public EngineException {
	...
	class OSKAPI_CALL ShaderLoadingException : public EngineException {
	...
	class OSKAPI_CALL ShaderCompilingException : public EngineException {
	...
	class OSKAPI_CALL PipelineLayoutCreationException : public EngineException {
