...
namespace OSK::GRAPHICS {
	...
	public:
		...
		/// @brief Reenlaza todas las dependencias.
	...
	private:
		...
		DynamicArray<UniquePtr<MaterialInstance>> m_materialInstance;
		...
		DynamicArray<RenderPassImageInfo> m_colorTargets{};
		std::optional<RenderPassImageInfo> m_depthTarget = std::nullopt;
