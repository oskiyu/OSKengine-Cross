...
namespace OSK::GRAPHICS {
	...
	class OSKAPI_CALL MatrixBufferNotCreatedException : public EngineException {
	...
	class OSKAPI_CALL AccelerationStructureCreationException : public EngineException {
	...
	class OSKAPI_CALL RtShaderBindingTableCreationException : public EngineException {
