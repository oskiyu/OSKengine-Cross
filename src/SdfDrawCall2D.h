...
namespace OSK::GRAPHICS {
	...
	struct OSKAPI_CALL SdfDrawCall2D {

		/// @param view Vista de la imagen a renderizar.
		/// @return Draw call rectangular para una imagen.
		static SdfDrawCall2D Texture(const IGpuImageView& view);
