...
namespace OSK::GRAPHICS {
	...
	private:
		...
		static std::unordered_map<GdrBufferUuid, GpuBufferUsage> GetBufferUses(const std::unordered_map<GdrBufferUuid, DynamicArray<PartialRgBufferDependency>>& dependencies);
